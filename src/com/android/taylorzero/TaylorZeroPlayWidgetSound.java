...
public class TaylorZeroPlayWidgetSound {
	...
	public TaylorZeroPlayWidgetSound(Context context) {
		mContext = context;
	}

	// test play Mp3
	public void playWidgetSoundMp3(String file_path) {
		...
		if (null == mediaplayer_mp3) {
			Toast.makeText(mContext, "Loading click sound null!",
					Toast.LENGTH_SHORT).show();
			((Activity) mContext).finish();
			return;
		}
